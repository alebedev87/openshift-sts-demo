...
# 2. Extract cluster operator's CredentilsRequest.
...
# 3. Create all: AWS Identity provider, AWS S3 bucket, cluster operator roles and generate cluster operator secrets.
